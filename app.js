...
Dino.prototype.dietCompare = function dietCompare(human) {
...
Dino.prototype.heightCompare = function heightCompare(human) {
...
Dino.prototype.weightCompare = function weightCompare(human) {
...
Dino.prototype.randomInfo = function randomInfo(human) {
...
button.addEventListener('click', (event) => {
  ...
  const createDinos = async () => {
    ...
    const dinoList = dinos.Dinos.map((dino) => new Dino(
      dino.species,
      dino.height,
      dino.weight,
      dino.diet,
